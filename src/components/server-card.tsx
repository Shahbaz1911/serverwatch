...
export function ServerCard({ name, url, icon: Icon, status, animationDelay, color = 'blue', port, uptime }: ServerCardProps) {
  ...
  return (
    ...
    >
        <Card className="h-full transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:border-accent flex flex-col">
          <CardHeader>
